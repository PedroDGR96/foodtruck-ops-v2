  ...
  describe "#recalculate_totals! money math" do
    ...
    it "computes total from subtotal plus tax and delivery fee without addons" do
      Tenancy.with_business(business) do
        ...
        # subtotal = (7.50 + 0).round(2) * 2 = 15.00
    ...
    it "characterizes money math for an order with diverse items and partial payment" do
      Tenancy.with_business(business) do
        order = create(
          :order,
          business: business,
        ...
        create(:order_item_addon, order_item: item_a, name: "Extra cheese", price: 3.75)

        # Item B: medium quantity without addon
        item_b = create(
          :order_item,
          order: order,
          product_name: "Fries",
        ...
        # Item C: low quantity with small addon
        item_c = create(
          :order_item,
          order: order,
          product_name: "Taco",
    ...
    it "characterizes the invariant that total equals subtotal plus tax plus delivery fee across diverse inputs" do
      Tenancy.with_business(business) do
        order = create(
          :order,
          business: business,
        ...
        item_a = create(
          ...
          product_name: "Burger",
          quantity: 7,
          unit_price: 13.25489617,
          line_total: 0.0
        )
        create(:order_item_addon, order_item: item_a, name: "Extra cheese", price: 2.3456789)
        ...
        item_c = create(
          ...
          product_name: "Taco",
          quantity: 3,
          unit_price: 5.987654321,
          line_total: 0.0
        )
        create(:order_item_addon, order_item: item_c, name: "Extra topping", price: 1.1234567)
